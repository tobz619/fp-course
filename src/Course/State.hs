...
isHappy ::
  Integer
  -> Bool
isHappy x = contains 1 $ firstRepeat (produce (sumOfSquares . listh . show) (P.fromIntegral x))
  where sumOfSquares = sum . ((square . digitToInt) <$>)
        square a = join (*) a
